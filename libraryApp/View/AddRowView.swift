        ...
        VStack(spacing: 12) {
            ...
            VStack(alignment: .leading, spacing: 12) {
                ...
                Button(action: {
                    ...
                    viewModel.addGame(game_name: gameName, game_completed: gameCompleted == "Ukończona" ? true : false, game_creator: creator, game_type: selectedType, game_progress: progress)
                    dismiss()
                }, label: {
                    Text("Zapisz")
                        .font(.callout)
